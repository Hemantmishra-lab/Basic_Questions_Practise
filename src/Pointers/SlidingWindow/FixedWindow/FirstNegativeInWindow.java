...
//
//public class FirstNegativeInWindow {
//    public static int[] calcFirstNegativeNumberInWindow(int []arr,int k){
//        int left = 0;int result[] = new int[arr.length-k+1];
//        int resultIndex = 0;
//        Queue<Integer> q = new LinkedList<>();
...
//        int[] arr = {12, -1, -7, 8, -15, 30};
//        int k = 3;
//        System.out.println(Arrays.toString(calcFirstNegativeNumberInWindow(arr,k)));
//    }
//}

//public class FirstNegativeInWindow {
//    public static int[] calcFirstNegativeInWindow(int []arr,int k){
//        int left = 0;int []result = new int[arr.length-k+1];
//        int resultIndex = 0;
//        Queue<Integer> q = new LinkedList<>();
//        for(int right = 0;right<arr.length;right++){
...
//public class FirstNegativeInWindow {
//    public static int[] calcFirstNegativeInWindow(int []arr,int k){
//        int left = 0;int []result = new int[arr.length-k+1];int resultIndex = 0;
//        Queue<Integer> q = new LinkedList<>();
//        for(int right = 0;right<arr.length;right++){
//            if(arr[right]<0){
//                q.add(arr[right]);
